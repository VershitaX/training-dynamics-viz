...
st.set_page_config(page_title="Training Dynamics Visualizer", page_icon="🎞️", layout="wide")

st.title("🎞️ Training Dynamics Visualizer")
...
with col_right:
    ...
    attn_df = pd.DataFrame(pattern, index=list(attn_prompt), columns=list(attn_prompt))
